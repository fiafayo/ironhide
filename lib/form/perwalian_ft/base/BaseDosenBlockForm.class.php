...
/**
 * DosenBlock form base class.
 *
 * @method DosenBlock getObject() Returns the current form's model object
 *
 * @package    perwalianft
 * @subpackage form
 ...
 */
abstract class BaseDosenBlockForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dosen_block[%s]');
