...
/**
 * Base class that represents a row from the 'tk_transkrip' table.
 *
 * 
 *
 ...
 */
abstract class BaseTranskrip extends BaseObject  implements Persistent {
	 ...
	 * @return     Transkrip The current object (for fluent API support)
	 */
	public function setNrp($v)
	{
		...
		if ($this->nrp !== $v) {
			$this->nrp = $v;
			$this->modifiedColumns[] = TranskripPeer::NRP;
		}
	...
	public function setKodeMk($v)
	{
		...
		if ($this->kode_mk !== $v) {
			$this->kode_mk = $v;
			$this->modifiedColumns[] = TranskripPeer::KODE_MK;
		}
	...
	public function setSemester($v)
	{
		...
		if ($this->semester !== $v) {
			$this->semester = $v;
			$this->modifiedColumns[] = TranskripPeer::SEMESTER;
		}
	...
	public function setTahun($v)
	{
		...
		if ($this->tahun !== $v) {
			$this->tahun = $v;
			$this->modifiedColumns[] = TranskripPeer::TAHUN;
		}
	...
	public function setNilai($v)
	{
		...
		if ($this->nilai !== $v) {
			$this->nilai = $v;
			$this->modifiedColumns[] = TranskripPeer::NILAI;
		}
	...
	public function setState($v)
	{
		...
		if ($this->state !== $v) {
			$this->state = $v;
			$this->modifiedColumns[] = TranskripPeer::STATE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = TranskripPeer::NUM_COLUMNS - TranskripPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Transkrip object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TranskripPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTranskrip:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TranskripPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTranskrip:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTranskrip:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTranskrip:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				TranskripPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TranskripPeer::doInsert($this, $con);
					...
					$affectedRows += TranskripPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TranskripPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TranskripPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TranskripPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getNrp(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TranskripPeer::NRP)) $criteria->add(TranskripPeer::NRP, $this->nrp);
		if ($this->isColumnModified(TranskripPeer::KODE_MK)) $criteria->add(TranskripPeer::KODE_MK, $this->kode_mk);
		if ($this->isColumnModified(TranskripPeer::SEMESTER)) $criteria->add(TranskripPeer::SEMESTER, $this->semester);
		if ($this->isColumnModified(TranskripPeer::TAHUN)) $criteria->add(TranskripPeer::TAHUN, $this->tahun);
		if ($this->isColumnModified(TranskripPeer::NILAI)) $criteria->add(TranskripPeer::NILAI, $this->nilai);
		if ($this->isColumnModified(TranskripPeer::STATE)) $criteria->add(TranskripPeer::STATE, $this->state);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TranskripPeer::SEMESTER, $this->semester);
		$criteria->add(TranskripPeer::TAHUN, $this->tahun);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Transkrip (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Transkrip Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TranskripPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TranskripPeer();
		}
		return self::$peer;
	}
	...
	public function getMahasiswa(PropelPDO $con = null)
	{
		if ($this->aMahasiswa === null && (($this->nrp !== "" && $this->nrp !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aMahasiswa->addTranskrips($this);
			 */
		}
	...
	public function getMataKuliah(PropelPDO $con = null)
	{
		if ($this->aMataKuliah === null && (($this->kode_mk !== "" && $this->kode_mk !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMataKuliah->addTranskrips($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTranskrip:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTranskrip::%s', $method));
	  }
