...
/**
 * Base static class for performing query and update operations on the 'tk_admin' table.
 *
 * 
 *
...
abstract class BaseAdminPeer {
	...
	const TABLE_NAME = 'tk_admin';

	/** the related Propel class for this table */
	const OM_CLASS = 'Admin';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.perwalian_ft.Admin';
	...
	const NIK = 'tk_admin.NIK';

	/** the column name for the NAMA field */
	const NAMA = 'tk_admin.NAMA';

	/** the column name for the KODE_JUR field */
	const KODE_JUR = 'tk_admin.KODE_JUR';

	/** the column name for the PASSWORD field */
	const PASSWORD = 'tk_admin.PASSWORD';

	/** the column name for the JABATAN field */
	const JABATAN = 'tk_admin.JABATAN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Nik', 'Nama', 'KodeJur', 'Password', 'Jabatan', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('nik', 'nama', 'kodeJur', 'password', 'jabatan', ),
		BasePeer::TYPE_COLNAME => array (self::NIK, self::NAMA, self::KODE_JUR, self::PASSWORD, self::JABATAN, ),
		BasePeer::TYPE_FIELDNAME => array ('nik', 'nama', 'kode_jur', 'password', 'jabatan', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Nik' => 0, 'Nama' => 1, 'KodeJur' => 2, 'Password' => 3, 'Jabatan' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('nik' => 0, 'nama' => 1, 'kodeJur' => 2, 'password' => 3, 'jabatan' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::NIK => 0, self::NAMA => 1, self::KODE_JUR => 2, self::PASSWORD => 3, self::JABATAN => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('nik' => 0, 'nama' => 1, 'kode_jur' => 2, 'password' => 3, 'jabatan' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		$criteria->addSelectColumn(AdminPeer::NIK);
		$criteria->addSelectColumn(AdminPeer::NAMA);
		$criteria->addSelectColumn(AdminPeer::KODE_JUR);
		$criteria->addSelectColumn(AdminPeer::PASSWORD);
		$criteria->addSelectColumn(AdminPeer::JABATAN);
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to tk_admin
	...
	public static function doCountJoinJurusan(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AdminPeer::KODE_JUR, JurusanPeer::KODE_JUR, $join_behavior);
	...
	/**
	 * Selects a collection of Admin objects pre-filled with their Jurusan objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinJurusan(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Admin) to $obj2 (Jurusan)
				$obj2->addAdmin($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Admin) to the collection in $obj2 (Jurusan)
				$obj2->addAdmin($obj1);
    ...
    foreach (sfMixer::getCallables('BaseAdminPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseAdminPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AdminPeer::NIK);
			$selectCriteria->add(AdminPeer::NIK, $criteria->remove(AdminPeer::NIK), $comparison);
	...
	/**
	 * Method to DELETE all rows from the tk_admin table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AdminPeer::NIK, (array) $values, Criteria::IN);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(AdminPeer::DATABASE_NAME);
			$criteria->add(AdminPeer::NIK, $pks, Criteria::IN);
