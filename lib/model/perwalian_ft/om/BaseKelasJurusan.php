...
/**
 * Base class that represents a row from the 'tk_kls_jur' table.
 *
 * 
 *
 ...
 */
abstract class BaseKelasJurusan extends BaseObject  implements Persistent {
	 ...
	 * @return     KelasJurusan The current object (for fluent API support)
	 */
	public function setKodeKelas($v)
	{
		...
		if ($this->kode_kelas !== $v) {
			$this->kode_kelas = $v;
			$this->modifiedColumns[] = KelasJurusanPeer::KODE_KELAS;
		}
	...
	public function setKodeJur($v)
	{
		...
		if ($this->kode_jur !== $v) {
			$this->kode_jur = $v;
			$this->modifiedColumns[] = KelasJurusanPeer::KODE_JUR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = KelasJurusanPeer::NUM_COLUMNS - KelasJurusanPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating KelasJurusan object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = KelasJurusanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseKelasJurusan:delete:pre') as $callable)
			{
			...
			if ($ret) {
				KelasJurusanPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseKelasJurusan:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseKelasJurusan:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseKelasJurusan:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				KelasJurusanPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = KelasJurusanPeer::doInsert($this, $con);
					...
					$affectedRows += KelasJurusanPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = KelasJurusanPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = KelasJurusanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = KelasJurusanPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(KelasJurusanPeer::KODE_KELAS)) $criteria->add(KelasJurusanPeer::KODE_KELAS, $this->kode_kelas);
		if ($this->isColumnModified(KelasJurusanPeer::KODE_JUR)) $criteria->add(KelasJurusanPeer::KODE_JUR, $this->kode_jur);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of KelasJurusan (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     KelasJurusan Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     KelasJurusanPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new KelasJurusanPeer();
		}
		return self::$peer;
	}
	...
	public function getKelasMK(PropelPDO $con = null)
	{
		if ($this->aKelasMK === null && (($this->kode_kelas !== "" && $this->kode_kelas !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aKelasMK->addKelasJurusans($this);
			 */
		}
	...
	public function getJurusan(PropelPDO $con = null)
	{
		if ($this->aJurusan === null && (($this->kode_jur !== "" && $this->kode_jur !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aJurusan->addKelasJurusans($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseKelasJurusan:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseKelasJurusan::%s', $method));
	  }
