...
<div class="panel panel-default">
  ...
  <div class="panel-heading">Daftar Dosen Jaga</div>
...
foreach( $kodeKars as $kodeKar  ):
    ...
    $namaKar = ( isset( $penjadwalan->dosenReffs[$kodeKar] ) ) ? $penjadwalan->dosenReffs[$kodeKar] : '';
...
?>
          <tr <?php echo $class;?> >
              ...
              $data=  getRuangBySlot($isiRuangPerSlot,$slot, $kodeKar, true);
