...
if ($print) {
    ...
    if ($xls) {
        ...
        echo "<input type=\"button\" name=\"xlsButton\" value=\"Export ke XLS\" onclick=\"document.location='/index.php/jadwal_ujian/jadwalRinciDosen?xls=1'\" />";
    }
    echo "<input type=\"button\" name=\"printButton\" value=\"Print\" onclick=\"document.location='/index.php/jadwal_ujian/jadwalRinciDosen?print=1'\" />";
}
...
<div id="sf_printout_container">
    ...
    <thead>
        <tr>
            <td colspan="6"><h1>Jadwal Jaga Ujian Untuk Dosen</h1></td>
        </tr>
        <tr>
...
{
    if (isset($dosenNames[$kdos]) ) $namaDosen = $dosenNames[$kdos] ; else $namaDosen= $kdos;
?>
        <tr>
            <th colspan="6" style="padding-top: 20px">
                <?php echo "Kode : ".$kdos."&nbsp;&nbsp; Nama Dosen : ".$namaDosen; ?>
            </th>
        </tr>        
<?php
