...
$ft=fopen("transkrip_all.csv","w"); 


     //SEKARANG AMBIL TRANSKRIPNYA
    //$ft=fopen("transkrip_".$digitJurusan.".csv","a");
    $sql3= 
            "SELECT NRP,ThnAkademik,Semester,KodeMK,KodeNisbi FROM MhsTranskrip  WHERE (substring(NRP,1,1)='6') AND ((substring(NRP,2,1)='0') OR (substring(NRP,2,1)='1')) ORDER BY NRP,ThnAkademik,Semester,KodeMK,KodeNisbi" 
        ;
