<?
	...
	$pdf->Cell($kolom,$baris,'LAPORAN REKAPITULASI PESERTA MATA KULIAH ',0,1,'C');
	...
	$pdf->Cell(30,$baris,'KAPASITAS ',1,0,'C');
	$pdf->Cell(30,$baris,'TERDAFTAR ',1,1,'C');
	...
	if($lap)	{
		foreach($lap as $display)	{
			...
			$pdf->Cell(30,$baris,$display['kapasitas'],1,0,'R');
			$isi = getAllPendaftarKls($display['kode_kelas'],$_GET['semester'],$_GET['tahun']);
			$pdf->Cell(30,$baris,$isi,1,1,'R');
		}
	}
