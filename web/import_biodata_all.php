...
$sql="SELECT NRP,Nama,Pin,KodeStatus,IPKDenganE,IPKTanpaE,IPSAkhir,SksMaxDepan,SKSKumTanpaE FROM Mahasiswa WHERE (substring(NRP,1,1)='6') AND ((substring(NRP,2,1)='0') OR (substring(NRP,2,1)='1')) AND (KodeStatus NOT IN ('DO','PO','L')) AND (NRP<'6054000') ORDER BY NRP DESC $limit";
