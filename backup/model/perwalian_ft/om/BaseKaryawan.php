...
abstract class BaseKaryawan extends BaseObject  implements Persistent {
	 ...
	 * related KaryawanBlocks from storage. If this Karyawan is new, it will return
	 ...
	 */
	public function getKaryawanBlocksJoinJadwalUjian($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(KaryawanPeer::DATABASE_NAME);
		}
		...
		if ($this->collKaryawanBlocks === null) {
			if ($this->isNew()) {
				...
				$this->collKaryawanBlocks = KaryawanBlockPeer::doSelectJoinJadwalUjian($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
