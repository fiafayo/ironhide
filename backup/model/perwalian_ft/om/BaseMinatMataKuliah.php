...
/**
 * Base class that represents a row from the 'tk_minat_mk' table.
 *
 * 
 *
 ...
 */
abstract class BaseMinatMataKuliah extends BaseObject  implements Persistent {
	...
	const PEER = 'MinatMataKuliahPeer';
	...
	/**
	 * Initializes internal state of BaseMinatMataKuliah object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     MinatMataKuliah The current object (for fluent API support)
	 */
	public function setNrp($v)
	{
		...
		if ($this->nrp !== $v) {
			$this->nrp = $v;
			$this->modifiedColumns[] = MinatMataKuliahPeer::NRP;
		}
	...
	public function setKodeMk($v)
	{
		...
		if ($this->kode_mk !== $v) {
			$this->kode_mk = $v;
			$this->modifiedColumns[] = MinatMataKuliahPeer::KODE_MK;
		}
	...
	public function setAngkatan($v)
	{
		...
		if ($this->angkatan !== $v || $this->isNew()) {
			$this->angkatan = $v;
			$this->modifiedColumns[] = MinatMataKuliahPeer::ANGKATAN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->angkatan = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = MinatMataKuliahPeer::NUM_COLUMNS - MinatMataKuliahPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating MinatMataKuliah object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = MinatMataKuliahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseMinatMataKuliah:delete:pre') as $callable)
			{
			...
			if ($ret) {
				MinatMataKuliahPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseMinatMataKuliah:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseMinatMataKuliah:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseMinatMataKuliah:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				MinatMataKuliahPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = MinatMataKuliahPeer::doInsert($this, $con);
					...
					$affectedRows += MinatMataKuliahPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = MinatMataKuliahPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = MinatMataKuliahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = MinatMataKuliahPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getNrp(),
			$keys[1] => $this->getKodeMk(),
			$keys[2] => $this->getAngkatan(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAngkatan($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MinatMataKuliahPeer::NRP)) $criteria->add(MinatMataKuliahPeer::NRP, $this->nrp);
		if ($this->isColumnModified(MinatMataKuliahPeer::KODE_MK)) $criteria->add(MinatMataKuliahPeer::KODE_MK, $this->kode_mk);
		if ($this->isColumnModified(MinatMataKuliahPeer::ANGKATAN)) $criteria->add(MinatMataKuliahPeer::ANGKATAN, $this->angkatan);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of MinatMataKuliah (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     MinatMataKuliah Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     MinatMataKuliahPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new MinatMataKuliahPeer();
		}
		return self::$peer;
	}
	...
	public function getMahasiswa(PropelPDO $con = null)
	{
		if ($this->aMahasiswa === null && (($this->nrp !== "" && $this->nrp !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aMahasiswa->addMinatMataKuliahs($this);
			 */
		}
	...
	public function getMataKuliah(PropelPDO $con = null)
	{
		if ($this->aMataKuliah === null && (($this->kode_mk !== "" && $this->kode_mk !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMataKuliah->addMinatMataKuliahs($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseMinatMataKuliah:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseMinatMataKuliah::%s', $method));
	  }
