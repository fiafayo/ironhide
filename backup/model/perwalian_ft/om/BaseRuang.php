...
abstract class BaseRuang extends BaseObject  implements Persistent {
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Ruang has previously been saved, it will retrieve
	 * related RuangBlocks from storage. If this Ruang is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * actually need in Ruang.
	 */
	public function getRuangBlocksJoinJadwalUjian($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(RuangPeer::DATABASE_NAME);
		}
		...
		if ($this->collRuangBlocks === null) {
			if ($this->isNew()) {
				...
				$this->collRuangBlocks = RuangBlockPeer::doSelectJoinJadwalUjian($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
