...
/**
 * Base class that represents a row from the 'dosen_mk' table.
 *
 * 
 *
 ...
 */
abstract class BaseDosenMataKuliah extends BaseObject  implements Persistent {
	...
	const PEER = 'DosenMataKuliahPeer';
	 ...
	 * @return     DosenMataKuliah The current object (for fluent API support)
	 */
	public function setKodeDosen($v)
	{
		...
		if ($this->kode_dosen !== $v) {
			$this->kode_dosen = $v;
			$this->modifiedColumns[] = DosenMataKuliahPeer::KODE_DOSEN;
		}
	...
	public function setKodeMk($v)
	{
		...
		if ($this->kode_mk !== $v) {
			$this->kode_mk = $v;
			$this->modifiedColumns[] = DosenMataKuliahPeer::KODE_MK;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = DosenMataKuliahPeer::NUM_COLUMNS - DosenMataKuliahPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating DosenMataKuliah object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DosenMataKuliahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseDosenMataKuliah:delete:pre') as $callable)
			{
			...
			if ($ret) {
				DosenMataKuliahPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDosenMataKuliah:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseDosenMataKuliah:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDosenMataKuliah:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				DosenMataKuliahPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = DosenMataKuliahPeer::doInsert($this, $con);
					...
					$affectedRows += DosenMataKuliahPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DosenMataKuliahPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DosenMataKuliahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = DosenMataKuliahPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DosenMataKuliahPeer::KODE_DOSEN)) $criteria->add(DosenMataKuliahPeer::KODE_DOSEN, $this->kode_dosen);
		if ($this->isColumnModified(DosenMataKuliahPeer::KODE_MK)) $criteria->add(DosenMataKuliahPeer::KODE_MK, $this->kode_mk);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DosenMataKuliah (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DosenMataKuliah Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     DosenMataKuliahPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new DosenMataKuliahPeer();
		}
		return self::$peer;
	}
	...
	public function getDosen(PropelPDO $con = null)
	{
		if ($this->aDosen === null && (($this->kode_dosen !== "" && $this->kode_dosen !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aDosen->addDosenMataKuliahs($this);
			 */
		}
		return $this->aDosen;
	}
	...
	public function getMataKuliah(PropelPDO $con = null)
	{
		if ($this->aMataKuliah === null && (($this->kode_mk !== "" && $this->kode_mk !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMataKuliah->addDosenMataKuliahs($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseDosenMataKuliah:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseDosenMataKuliah::%s', $method));
	  }
